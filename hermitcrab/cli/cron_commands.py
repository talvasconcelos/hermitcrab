...
from hermitcrab.cli.interactive import print_agent_response
...
def cron_run(
    ...
    agent_loop = AgentLoop(
        bus=bus,
        **build_agent_loop_kwargs(config, provider),
    )
    ...
    if asyncio.run(run()):
        ...
        if result_holder:
            print_agent_response(result_holder[0], render_markdown=True, console=console)
    else:
